...
public class FullRSNonUniformMutator extends UniformMutator 
{
	/////////////////////////////////////////////////////////////////
	...
	public FullRSNonUniformMutator() 
	{
		super();
	}
	...
	{
		if (other instanceof FullRSNonUniformMutator) {
			FullRSNonUniformMutator o = (FullRSNonUniformMutator) other;
	...
	protected void doLocusMutation(double[] parentChromosome, double[] mutantChromosome, int locusIndex) 
	{
		...
		if (locusIndex < studentSimsIdx) {
			...
			if (locusIndex < subjectSimsIdx)
				newValue = randgen.choose(0, studentSimsOpc);
			else
				newValue = randgen.choose(0, subjectSimsOpc);
		}
