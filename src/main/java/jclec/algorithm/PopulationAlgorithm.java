...
public abstract class PopulationAlgorithm extends AbstractAlgorithm implements IPopulation {
    ...
    private void setRandGenSettings(Configuration configuration) {
        // Random generators factory
        try {
            // Species classname
    ...
    @SuppressWarnings("unchecked")
    private void setSpeciesSettings(Configuration configuration) {
        // Individual species
        try {
            // Species classname
    ...
    @SuppressWarnings("unchecked")
    private void setEvaluatorSettings(Configuration configuration) {
        // Individuals evaluator
        try {
            // Evaluator classname
    ...
    @SuppressWarnings("unchecked")
    private void setProviderSettings(Configuration configuration) {
        try {
            // Provider classname
