...
/**
 * Multi-instance multi-label Classification Algorithm
 * 
 * @author Alberto Cano 
 * @author Amelia Zafra
...
public abstract class MIMLClassificationAlgorithm extends ClassificationAlgorithm 
{
	// ///////////////////////////////////////////////////////////////
	...
	public MIMLClassificationAlgorithm() {
		super();
	}
	...
	protected void setDatasetSettings(Configuration settings)
	{
		try {
			...
			getTrainSet().setMetadata(new MIMLClassificationMetadata(numberClasses));
			...
			getTestSet().setMetadata(new MIMLClassificationMetadata(numberClasses));
